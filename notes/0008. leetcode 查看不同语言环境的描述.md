---
id: 4f40c6ae-95ef-4a4f-8379-974bc4d1e8bf
description: 在切换语言选项的右侧有一个 ! 叹号，点击即可查看官方对该语言执行环境的描述，以便了解到都注入了哪些模块。
---

```mindmap [本节内容]
- 知识点
  - 学会在 leetcode 中查看不同语言环境的描述
- 评价
  - 如果你也在 Leetcode 上刷题，这篇笔记中记录的内容或许能够帮你在某些题中以更简洁的写法去解决问题。
```

## 1. 在 Leetcode 中查看不同语言环境的描述
...
## 2. 示例：使用内置的数据结构简化题解的示例（Leetcode 例题：703. 数据流中的第 K 大元素）
...
之前使用 `MinPriorityQueue` 的写法提交的时候没有通过，随后给官方提了反馈，写这篇笔记时 `25.09.23` 再次提交又通过了，-\_-||。

---

当时提交没有通过，在网上查了些相关资料，也有人遇到 [类似的问题][5]，原因出在了 Leetcode 中使用的 `datastructures-js` 的版本过旧导致的 BUG。

![其他用户反馈过类似版本问题](https://cdn.jsdelivr.net/gh/tnotesjs/imgs@main/2025-09-23-06-56-08.png)
