...
- [2. 🫧 评价](#2--评价)
- [3. 🤔 KMP 是什么？](#3--kmp-是什么)
- [4. 🤔 考察 KMP 算法的 LeetCode 例题都有哪些？](#4--考察-kmp-算法的-leetcode-例题都有哪些)
- [5. 🤔 haystack、needle 是什么？](#5--haystackneedle-是什么)
- [6. 🤔 KMP 算法的基本思想是什么？](#6--kmp-算法的基本思想是什么)
- [7. 🤔 next 数组是什么？](#7--next-数组是什么)
- [8. 🔍 相关 LeetCode 例题 - `28. 实现 strStr()`](#8--相关-leetcode-例题---28-实现-strstr)
  - [8.1. 📝 题目描述](#81--题目描述)
  - [8.2. 解法 1：暴力解法](#82-解法-1暴力解法)
  - [8.3. 解法 2：KMP](#83-解法-2kmp)
    - [核心步骤](#核心步骤)
