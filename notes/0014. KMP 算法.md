---
id: 16601dfe-0be3-4091-ae9b-c1c97242f5d3
---
...
- 内容概述
  - KMP 算法简介
  - 了解 KMP 算法的相关术语
  - 通过 LeetCode 例题 `28. 实现 strStr()` 来了解 KMP 算法的基本工作原理
- KMP 算法的核心
  - 一句话描述：**构建并维护 next 数组，利用已匹配的信息避免重复比较。**
- 考察 KMP 算法的相关 LeetCode 例题
  - `28. 实现 strStr()`
    - 这篇笔记将以 LeetCode 例题 `28. 实现 strStr()` 为引子来介绍 KMP 算法
    - 不过这道题本身是一道简单题，使用朴素匹配的做法完全没问题，而且从 LeetCode 官方提交结果来看，暴力的做法反而更好
      - 这也告诉我们 \=\> 算法的选择应结合当前应用场景下实际数据的特征来定
    - 其他例题可以在刷完这篇笔记之后，再去找来练手巩固
  - `214. 最短回文串`
  - `459. 重复的子字符串`
  - `686. 重复叠加字符串匹配`
  - `1392. 最长快乐前缀`
